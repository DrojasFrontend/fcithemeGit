...
<!-- CONTENIDO -->
  <main class="paginaEtapaExpecialidades">
    <?php if($mostrar_hero) : ?>
      <!-- Hero -->
        <?php get_template_part('template-parts/especialidades/seccion', 'hero', array('class' => 'paginaNefrologiaPediatrica') );?>
      <!-- Fin Hero -->
    <?php endif; ?>
    ...
    <?php if($mostrar_items_iconos) : ?>
      <!-- Items Iconos -->
        <?php get_template_part('template-parts/especialidades/seccion', 'items-iconos', array('class' => 'paginaNefrologiaPediatrica'));?>
      <!-- Fin Items Iconos -->
    <?php endif; ?>
